    ...
    <section className="relative pt-24 sm:pt-28 pb-12 sm:pb-20 overflow-hidden">
      ...
      <Container className="relative">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F8F0E8] border border-[#E8A96B]/20 text-xs text-[#C56A2D] font-medium">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-medium text-[#171717] tracking-tight leading-[1.1] max-w-2xl"
          >
          ...
          <motion.p
            ...
            className="mt-4 sm:mt-5 text-base sm:text-lg text-[#676767] max-w-xl leading-relaxed"
          >
