        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.h1
              ...
              animate={prefersReducedMotion ? {} : { opacity: 1, y: 0 }}
              transition={{ duration: 0.5, ease: [0.25, 0.1, 0.25, 1], delay: 0.3 }}
              className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#171717] tracking-tight leading-[1.08]"
            >
            ...
            <motion.p
              ...
              className="mt-5 sm:mt-6 text-base sm:text-lg text-[#676767] leading-relaxed max-w-lg"
            >
            ...
            >
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-3xl font-bold text-[#171717]">R$ 197</span>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="/checkout"
                  className="inline-flex items-center justify-center gap-2 rounded-md font-semibold transition-all duration-200 cursor-pointer px-8 py-3.5 text-base text-white bg-[#C56A2D] hover:bg-[#B35C24] active:bg-[#A04F1E] shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
                >
              ...
              <div className="mt-3 flex items-center gap-2 text-xs font-medium text-[#2E7D32]">
          ...
          >
            {badges.map((badge) => (
              <motion.span
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-[#EDE9E3] text-xs font-medium text-[#676767]"
              >
