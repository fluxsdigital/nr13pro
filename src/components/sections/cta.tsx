          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl font-medium transition-all duration-200 cursor-pointer px-7 py-3 text-base text-[#25D366] hover:text-white hover:bg-[#25D366]"
              >
