  ...
  return (
    <div className="min-h-screen bg-[#F7F5F2]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <h1 className="text-3xl sm:text-4xl font-medium text-[#171717] tracking-tight mb-8">Política de Privacidade</h1>

        <div className="space-y-6 text-sm text-[#676767] leading-relaxed">
          <p>Última atualização: julho de 2026.</p>

          <h2 className="text-lg font-medium text-[#171717] pt-4">1. Introdução</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">2. Dados Coletados</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">3. Finalidade do Tratamento</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">4. Base Legal</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">5. Compartilhamento de Dados</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">6. Armazenamento e Segurança</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">7. Direitos do Usuário</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">8. Cookies</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">9. Retenção de Dados</h2>
          ...
          <h2 className="text-lg font-medium text-[#171717] pt-4">10. Contato</h2>
