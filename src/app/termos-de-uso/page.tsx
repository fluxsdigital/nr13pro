  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <h1 className="text-3xl sm:text-4xl font-medium text-text-primary tracking-tight mb-8">Termos de Uso</h1>

        <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
          <p>Última atualização: julho de 2026.</p>

          <h2 className="text-lg font-medium text-text-primary pt-4">1. Aceitação dos Termos</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">2. Descrição do Serviço</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">3. Cadastro e Conta</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">4. Assinatura e Pagamento</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">5. Uso Permitido</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">6. Propriedade Intelectual</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">7. Limitação de Responsabilidade</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">8. Alterações nos Termos</h2>
          ...
          <h2 className="text-lg font-medium text-text-primary pt-4">9. Contato</h2>
